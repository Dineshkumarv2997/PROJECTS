...
//EmbedMessage.java
 ...
 public class StegEmbedMessage extends JFrame implements ActionListener
 {
 JButton open = new JButton("Open"), embed = new JButton("Embed"),
    save = new JButton("Save into new file"), reset = new JButton("Reset"),icrypt=new JButton("Encrypt Image");
...
//       getMaximumWindowBounds());
 ...
 private void assembleInterface() {
    ...
    icrypt.addActionListener(this);
   save.addActionListener(this);   
    reset.addActionListener(this);
    open.setMnemonic('O');
    embed.setMnemonic('E');
    icrypt.setMnemonic('i');
    save.setMnemonic('S');
    reset.setMnemonic('R');
