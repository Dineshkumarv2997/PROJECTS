...
public class CryptMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("IMAGE CRYPTOGRAPHY");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CryptMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
